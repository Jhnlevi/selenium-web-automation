...
{
    public class CancelCheckoutFlow_E2ETests : BaseTest
    {
        ...
        public void E2E_CancelCheckout_And_ResumeShopping(
            string username,
            string password,
            string fname,
            string lname,
            string pcode)
        {
            ...
            // Checkout
            ReportManager.LogInfo("Clicking 'cancel' button.");
            _checkoutStepOne.ClickCancelButton();
            ReportManager.LogInfo("Verifying that user can cancel checkout process and go back to cart page.");
            AssertUrlContains("cart");
