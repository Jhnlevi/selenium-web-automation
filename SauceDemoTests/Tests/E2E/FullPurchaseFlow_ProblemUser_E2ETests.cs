...
{
    public class FullPurchaseFlow_ProblemUser_E2ETests : BaseTest
    {
        ...
        public void E2E_FullPurchaseFlow_ProblemUser(
            string username,
            string password,
            string fname,
            string lname,
            string pcode)
        {
            ...
            // Product
            ReportManager.LogInfo("Verifying that the images in inventory page do not load properly.");
            Assert.That(_product.VerifyAllImagesAreLoaded(), Is.False, "Problem user account; Expected broken images.");
